...
5. Attach the APK to a GitHub Release: complete through `v0.1.9`.
...
`versionName = "0.1.9"` and `versionCode = 9`.
...
- <https://github.com/chubbyk-uu/rust-gomoku/releases/tag/v0.1.9>
